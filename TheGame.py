...
print("!! REMINDER !!")
print("\n" + "Alle antwoorden moeten volledig worden beantwoord. Geen gebruik van 'caps' geeft een fout antwoord.")
...
if startGame == "Begin":
    ...
    print(
        ...
        "hij verlaat zijn huis om 08:02 uur en vanaf 08:26 uur pakt hij de bus. Met toeval is hij 08:58 uur op school",
        "",
    ...
    if startVraag1 == ("C"):
        ...
        "loopt langs het samenwerkingsgebouw tot hij bij een ingang eindigt.",
        "",
        ...
        startVraag2 = input("Richie is vervolgens op het schoolterrein en moet naar gebouw Azzurro hij kan 3 kanten op, waar moet hij heen? kies '1', '2' of '3'. Kijk naar de foto 'P. Vraag 2': ")
        ...
        if startVraag2 == "2":
            ...
            startVraag2fout = input("poep ")

        if startVraag2fout == "ja":
            print("Pammigiano Reggiano")
        else: 
            print("Goudse kaas")

    elif startVraag1 == ("B"):
        startVraag1fout = input("blabla ")

        if startVraag1fout == "ja":
            print("Pammigiano Reggiano")
    else: 
            print("Goudse kaas")